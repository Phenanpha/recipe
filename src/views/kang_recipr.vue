<template>
  <br>
    ...
    <router-link to="/recipes" ><li><a>สูตรทั้งหมด</a></li></router-link>
    <router-link to="/tom_recipe"><li><a>ต้ม</a></li></router-link>
    <router-link to="/pad_recipe"><li><a>ผัด</a></li></router-link>
    <router-link to="/kang_recipe"><li><a :class="{ 'actives': isActive('/kang_recipe') }">แกง</a></li></router-link>
    <router-link to="/tod_recipe"><li><a>ทอด</a></li></router-link>
    <router-link to="/yum_recipe"><li><a>ยำ</a></li></router-link>
    <router-link to="/thoon_recipe"><li><a>ตุ๋น</a></li></router-link>
    <router-link to="/nueng_recipe"><li><a>นึ่ง</a></li></router-link>
    <router-link to="/tam_recipe"><li><a>ตำ</a></li></router-link>
  </ul>
...
const fetch_recipes = async () => {
  try {
    const response = await axios.get(`${import.meta.env.VITE_API}/kang`) 
