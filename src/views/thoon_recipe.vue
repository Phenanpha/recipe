<template>
  <br>
    ...
    <router-link to="/thoon_recipe"><li><a :class="{ 'actives': isActive('/thoon_recipe') }">ตุ๋น</a></li></router-link>
...
const fetch_recipes = async () => {
  try {
    const response = await axios.get(`${import.meta.env.VITE_API}/thoon`) 
